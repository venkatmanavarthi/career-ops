...
Les autres modes (`scan`, `batch`, `pdf`, `tracker`, `auto-pipeline`, `deep`, `outreach`, `offers`, `project`, `training`) restent en EN. Leur contenu est surtout du tooling, des chemins et des commandes -- il doit rester independant de la langue.
