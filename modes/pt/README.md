...
> "Avaliar e candidaturas em portugues -- use `modes/pt/_shared.md` e `modes/pt/offer.md`."
...
| `offer.md` | `modes/offer.md` (EN) | Avaliacao completa de uma vaga (Blocos A-F) |
...
Os demais modos (`scan`, `batch`, `pdf`, `tracker`, `auto-pipeline`, `deep`, `outreach`, `offers`, `project`, `training`) nao estao neste PR de proposito. Eles continuam funcionando via os originais em EN, pois seu conteudo e majoritariamente tooling, caminhos e comandos de configuracao — que devem ser independentes de idioma.
